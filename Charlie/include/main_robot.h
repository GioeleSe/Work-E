...
void self_led_green_on();          // turn on indefinitely (for held buttons)
void self_led_green_pulse(int ms); // turn on for ms milliseconds (for toggles/one-shot)
void self_led_green_off();         // turn off immediately
...
// return integer representation of property lights (actual value, casted bool or enum index)
int self_prop_get_lights();
// return integer representation of property brushes (actual value, casted bool or enum index)
...
// Set a new value for property lights (0=off, 1=on).
int self_prop_set_lights(int new_value);
// Set a new value for property brushes (0=off, 1=on).
int self_prop_set_brushes(int new_value);
